...
> Forked from [Flydrive](https://github.com/Slynova-Org/flydrive)
...
```javascript
const { StorageManager } = require('@ltv/storage');
...
```typescript
import { LocalFileSystemStorage } from '@ltv/storage';
